    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12" style="margin-top: 80px;">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <fieldset style="border: 2px solid #000; padding: 20px;">
                            ...
                            <hr>
                            <form action="payment-process.php" method="post" style="height: 350px;"><br><br>
                ...
                <button type="button" class="btn btn-secondary ml-2" onclick="location.href='index.php'">Home</button>
                            </form>
                        </fieldset>
                    </div>
                    <?php } ?>
